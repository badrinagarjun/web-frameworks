...
import com.example.springapp.service.BadriPersonService;

@RestController
public class BadriPersonController<Person> {
    public BadriPersonService personService;

    public BadriPersonController(BadriPersonService personService) {
